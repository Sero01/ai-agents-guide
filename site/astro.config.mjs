...
export default defineConfig({
	...
	integrations: [
		...
		starlight({
			...
			description: 'A beginner-friendly, code-first guide to AI agents, agentic workflows, MCP, LangChain, CrewAI, AutoGen, and agent design patterns. Free and updated for 2026.',
			logo: {
			...
			head: [
				...
				},
				{
					...
					content: JSON.stringify({
						...
						'description': 'A code-first guide to AI agents, agentic workflows, MCP, LangChain, CrewAI, and AutoGen. Free, beginner-friendly, updated 2026.',
						'publisher': {
							'@type': 'Person',
							'name': 'Parvez Ahmed',
