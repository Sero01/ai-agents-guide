...
head:
  - tag: meta
    attrs:
      property: og:title
      content: "Best-Of Guides — Tested Shortlists for AI Tools and Frameworks"
  - tag: meta
    attrs:
      property: og:description
      content: "Curated, tested shortlists of AI tools, agent frameworks, certifications, and LLMs. Shaped around specific use cases, re-tested on a recurring schedule."
  - tag: meta
    attrs:
      property: og:url
      content: https://agentguides.dev/best/
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: meta
    attrs:
      name: twitter:title
      content: "Best-Of Guides — AI Tools, Frameworks, Certifications"
  - tag: meta
    attrs:
      name: twitter:description
      content: "Tested shortlists shaped around specific jobs-to-be-done."
  - tag: meta
    attrs:
      name: twitter:image
      content: https://agentguides.dev/og/best.png
  - tag: link
    attrs:
      rel: canonical
      href: https://agentguides.dev/best/
  - tag: script
    attrs:
...
- [Reviews](/reviews/) — head-to-head reviews that often feed into the best-of shortlists.
- [AI Models Leaderboard](/leaderboard/) — sortable table behind the LLM comparison post.
- [Build Tutorials](/build/) — once you have picked a shortlist winner, the tutorials show you how to ship with it.
- [Learn](/learn/) — conceptual background on AI agents, agentic workflows, MCP, and frameworks.
