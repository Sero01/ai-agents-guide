...
Companion to the interactive <a href="/leaderboard/">AI Models Leaderboard</a>.
</aside>
...
Pair any of the above with <AffiliateLink tool="together" campaign="llm-benchmark-comparison-2026">Together AI</AffiliateLink> or <AffiliateLink tool="fireworks" campaign="llm-benchmark-comparison-2026">Fireworks AI</AffiliateLink> if you want hosted access, or <AffiliateLink tool="openrouter" campaign="llm-benchmark-comparison-2026">OpenRouter</AffiliateLink> for unified routing across providers.
...
The price-vs-performance scatter on the [Leaderboard](/leaderboard/) highlights the Pareto-optimal models — the ones that are not dominated by any cheaper alternative at equal-or-higher score. As of May 2026, the frontier consists of:
...
For observability on whichever model you end up choosing, <AffiliateLink tool="langfuse" campaign="llm-benchmark-comparison-2026">Langfuse</AffiliateLink> is first-rate and has a generous free tier. Helicone, long the other default pick, has been in maintenance mode since Mintlify acquired it in March 2026 — existing deployments keep working, but start new projects on Langfuse.
