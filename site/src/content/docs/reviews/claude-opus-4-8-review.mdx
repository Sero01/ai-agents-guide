...
- [Claude Opus 5 Review](/reviews/claude-opus-5-review/) — the successor that replaces Opus 4.8 at the same price and tops the Artificial Analysis Intelligence Index.
...
- [Claude Sonnet 5 Review](/reviews/claude-sonnet-5-review/) — the cheaper mid-tier sibling that sits just below Opus 4.8, for high-volume agent traffic.
