...
<strong>By Parvez Ahmed · Published June 10, 2026.</strong>
Launch-day assessment based on Anthropic's published API surface and pricing, run against our standard agent harness. Benchmark figures on the <a href="/leaderboard/">leaderboard</a> are positioned estimates until Anthropic ships a full model card. This post contains affiliate links to tools we use.
</aside>
