...
If you are running this at higher volume, route through <AffiliateLink tool="openrouter" campaign="research-agent-with-crewai">OpenRouter</AffiliateLink> for unified billing across providers, and add <AffiliateLink tool="helicone" campaign="research-agent-with-crewai">Helicone</AffiliateLink> for per-call cost tracking — both have generous free tiers.
