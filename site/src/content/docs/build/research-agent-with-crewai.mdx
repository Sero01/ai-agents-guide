...
- A Tavily API key for web search — sign up at <AffiliateLink tool="tavily" campaign="research-agent-with-crewai">tavily.com</AffiliateLink>; the free tier (1,000 requests/month) is enough for this tutorial
...
If you are running this at higher volume, route through <AffiliateLink tool="openrouter" campaign="research-agent-with-crewai">OpenRouter</AffiliateLink> for unified billing across providers, and add <AffiliateLink tool="langfuse" campaign="research-agent-with-crewai">Langfuse</AffiliateLink> for per-call tracing and cost tracking — both have generous free tiers.
...
For a structured course on top of this — covering the CrewAI patterns we did not use here, plus deployment — the <AffiliateLink tool="datacamp" campaign="research-agent-with-crewai">DataCamp CrewAI track</AffiliateLink> is the most current option we have used.
